...
/** FNV-1a 32 bits. Exported for the canvas review layer (R6.5-B Lot B), which hashes a
 *  changed unit's `before` per-unit to detect text drift between review sessions. */
