...
import { listConventions, listUnits, curatePreview, curate, updateUnitTextNorm } from "../lib/sidecarClient.ts";
...
export class CurationPane {
  ...
  /** decorateRow hook — R5.1b marker + R5.1c on-demand diff. Text editing itself is
   *  the transversal stylo, owned by CanvasUnitList (onEditText → _saveText). */
