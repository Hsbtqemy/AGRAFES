 ...
 *
 * P6 CSS architecture: Prep styles are now proper Vite-managed CSS files
 * (app.css + job-center.css).  Vite injects them automatically when this
 * dynamic chunk loads — no runtime style injection needed.
 */
...
// Prep CSS is now managed by Vite: these imports are bundled into this chunk.
