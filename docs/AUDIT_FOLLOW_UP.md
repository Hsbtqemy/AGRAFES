...
| QRY-07 | 🟡 | P2-19 | ✅ corrigé (P3) | `source_ext` échappe désormais `\ % _` + `LIKE ? ESCAPE '\'`, comme author/title → sémantique LIKE cohérente. `query.py`. |
