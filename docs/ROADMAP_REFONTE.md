...
- **R6.4** Tiroir « Avancé » (exceptions/history/diag) · responsive container-query · **retrait des écrans legacy** — **[FRONT]**. **Correction (R5.4)** : retirer **Cur/Annot** (relogés en R5.1/R5.2) ; **garder l'écran Segmentation** tant que le structure matcher (inter-doc) n'est pas relogé (R5.4d, différé).
