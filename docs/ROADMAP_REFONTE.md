...
- **R6.4** Tiroir « Avancé » (exceptions/history/diag) · responsive container-query · **retrait des écrans legacy** — **[FRONT]** *(cadrage : [`DESIGN_R6_4_canvas_parity.md`](DESIGN_R6_4_canvas_parity.md) — **24 écarts** canvas↔legacy vérifiés au code : le retrait régresserait ; 6 vrais ports + 6 relogements T3 avant tout retrait)*. **Correction (R5.4)** : retirer **Cur/Annot** (relogés en R5.1/R5.2) ; **garder l'écran Segmentation** tant que le structure matcher (inter-doc) n'est pas relogé (R5.4d, différé).
...
| R6 🟡 | **R6.1·R6.2·R6.3 ✅** (Prep + concordancier) · R6.4 (parité — cadrage) | **R6.1·R6.2·R6.3 ✅** | oui (1.6.47/48/49) | **024·025** | non |
