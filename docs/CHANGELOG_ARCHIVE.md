...
Entrées antérieures à la consolidation semver : schéma de versions « V… » (V0→V1.9)
et incréments initiaux ([0.1.0]→[0.6.1]). Le changelog **courant** est dans
[`../CHANGELOG.md`](../CHANGELOG.md). Archive figée (finding D-02).
