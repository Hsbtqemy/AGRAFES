...
| P2 | Onefile vs onedir decision gate | CI bench + aggregation exist; missing full matrix evidence | Collect macOS/Linux/Windows benchmark artifacts and move ADR-025 from pending to decided with explicit default mapping | in_progress |
