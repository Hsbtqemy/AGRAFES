# Visual Validation Prototypes

Static HTML prototypes for visual validation only.

No runtime app code is modified by these files.
...
```bash
open prototypes/visual-validation/index.html
```
