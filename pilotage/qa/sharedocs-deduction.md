...
- [ ] Choisir un fichier présent **à la fois** sur le serveur et sur le disque. Noter son verdict ShareDocs **mot pour mot**
- [ ] Ouvrir l'écran **Importer**, y déposer le même fichier depuis le disque, et comparer : **mode identique, motif identique, compte identique**. C'est la thèse du lot — un désaccord est un échec, même si les deux verdicts semblent plausibles
